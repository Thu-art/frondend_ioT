    ...
    Alert.alert(
      ...
      [
        ...
        { text: "Đăng xuất", style: "destructive", onPress: () => {
            // Thực hiện hành động đăng xuất, ví dụ navigate về màn hình login
...
>
  <Ionicons name="home-outline" size={28} color="#ff4444" />
      ...
      {/* Nút Xoá thiết bị luôn hiển thị nhưng disable khi chưa chọn */}
      <TouchableOpacity
...
const styles = StyleSheet.create({
  container: { 
    flex: 1, 
    padding: 20, backgroundColor: "#fff0f0" },
