...
export default function DeviceListScreen({ navigation, route }) {
  ...
  const [selectedDeviceId, setSelectedDeviceId] = useState(null); // thiết bị được chọn
  const [isDisabled, setIsDisabled] = useState(false); // disable các nút khi thêm mới/xem thông báo
  ...
  const handleAddDevice = () => {
    ...
    setTimeout(() => setIsDisabled(false), 3000); // sau 3s bật lại
  };
